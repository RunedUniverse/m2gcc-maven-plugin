...
@Component(role = IReferenceScanner.class, hint = "m2gcc-assembler")
public class AssemblerScanner implements IReferenceScanner {
	...
	public boolean logInfo(Log log) {
		...
		log.info("Scanner: Assembler  - Hello World!");
