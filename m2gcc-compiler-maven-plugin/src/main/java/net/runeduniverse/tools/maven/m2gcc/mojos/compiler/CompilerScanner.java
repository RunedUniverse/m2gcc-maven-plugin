...
@Component(role = IReferenceScanner.class, hint = "m2gcc-compiler")
public class CompilerScanner implements IReferenceScanner {
	...
	public boolean logInfo(Log log) {
		...
		log.info("Scanner: Compiler  - Hello World!");
